<script>
  ...
  export let ArtMark = 0
  export let ArtComments = 0
  export let ArtTitle = ""
  export let ArtText =""
  export let ArtImg =""
</script>
...
<div class="Modal">
  <ArticleHeader/>
  <ArticleLink ArtTitle={ArtTitle} ArtText={ArtText} ArtImg={ArtImg}/> 
  <ArticleFooter ArtMark={ArtMark} ArtComments={ArtComments}/>               
</div>
