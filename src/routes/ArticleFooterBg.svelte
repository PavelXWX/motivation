...
<div class="Footer">
  <div class="Left">
    <div class="Bookmark">
      <svg fill="aliceblue" width="25px" height="252px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <g id="Bookmark">
